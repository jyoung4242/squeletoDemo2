    ...
    function play(slot: Drum) {
      ...
      if (slot.drum === "KCK") {
        ...
        toneGain.gain.setValueCurveAtTime(
          new Float32Array([0.15 * vel, 0.15 * vel, 0.08 * vel, 0.05 * vel, 0.0]),
          ctx.currentTime,
          0.1
        ); //[0.2 * vel, 0.2 * vel, 0.13 * vel, 0.05 * vel, 0.0]
        ...
        noiseGain.gain.setValueCurveAtTime(new Float32Array([0.075 * vel, 0.03 * vel, 0.0]), ctx.currentTime, 0.08);
