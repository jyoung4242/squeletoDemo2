...
var _Keyboard = class {
  ...
  static terminate() {
    var _a, _b;
    (_a = this.element) == null ? void 0 : _a.removeEventListener("keydown", this.keyChange);
    (_b = this.element) == null ? void 0 : _b.removeEventListener("keyup", this.keyChange);
    this.element = null;
  }
  ...
  static unmap(mapping) {
    ...
    for (const key of this.pressed.keys()) {
      if (((_a = this.pressed.get(key)) == null ? void 0 : _a.keymap.mapping) === mapping) {
  ...
  static resolve(keys, eventType) {
    ...
    if (((_a = mapped.mapping) == null ? void 0 : _a.effectMode) === "instant") {
      (_c = (_b = mapped.mapping).callback) == null ? void 0 : _c.call(_b, mapped.action, eventType === "keydown", 0);
      return;
    }
  ...
  static update(deltaTime) {
    this.pressed.forEach((mapped, key) => {
      ...
      if (mapped.repeat === 0 || mapped.keymap.repeat && mapped.repeat <= 0) {
        (_b = (_a = mapped.keymap.mapping) == null ? void 0 : _a.callback) == null ? void 0 : _b.call(_a, mapped.keymap.action, true, deltaTime);
    ...
    this.lastPressed.forEach((keys) => {
      ...
      if (!this.pressed.has(keys)) {
        const mapped = this.mapped(keys);
        (_b = mapped == null ? void 0 : (_a = mapped.mapping).callback) == null ? void 0 : _b.call(_a, mapped.action, false, deltaTime);
      }
    });
    this.lastPressed = [...this.pressed.keys()];
  }
...
//# sourceMappingURL=@peasy-lib_peasy-input.js.map
